...
source scripts/scripts_01_setup.tcl
...
#scenario6:
initialize_floorplan -control_type core -shape T -orientation N -core_offset 5 -side_length {24 12 42 24 42 12}
